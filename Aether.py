...
#decknumber = str(221437)                                #Hardcoded value for debugging
decknumber = input("Please enter decknumber: ")        #Ask for decknumber 
prelink = "https://aetherhub.com/Deck/Gallery/"         #Define first part of url
...
decknumber = 'Aetherhub_Deck'+decknumber                          #Concat the work Deck and the number of the deck
...
with open(deck_txt_file_name, 'r+') as f:               #open in read / write mode
    f.readline()                                        #read the first line and throw it out
    data = f.read()                                     #read the rest
    f.seek(0)                                           #set the cursor to the top of the file
    f.write(data)                                       #write the data back
    f.truncate()                                        #set the file size to the current size
print('Deck.txt created!')
